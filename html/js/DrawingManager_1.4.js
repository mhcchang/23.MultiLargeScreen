        ...
        var j = function (r) {
            ...
            if (q == "mousedown") {
                ...
                if (blOverlay) {
                    ...
                    //console.log(g);
                    //console.log(g_rect);
                    g.removeOverlay(g_rect);

                    blOverlay = false;
                }

              //  console.log("down:");
                var ii = new BMap.Pixel(m.x, m.y);
                var gg = g.pixelToPoint(ii);
              //  console.log(gg);
            ...
            if (q == "mouseup") {
              ...
              //  console.log("up:");
               ...
               // console.log(gg);
                ...
                pt_ey = gg.lat;
                //callback coord
                callback(pt_sx, pt_sy, pt_ex, pt_ey);
                blOverlay = true;
            }
            var p = k(r);
            if (q == "click") {
